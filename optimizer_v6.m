function [X,high_sol,status,ratio_old,rfig,figs1,tt] = optimizer_v6(aim,n,U1,S1,C,Cpass,...
    Clowconstraint,M1_s,M2_s,M3_s,err,delSing,p_add,fgrid,plbul,Lk,Uk,order_r,...
...
%     end;%%%%%%%%%%%
    ...
    title([num2str(aim),'th. Iteration number: ',num2str(ii),' ratio: ',...
        num2str(Rat),' rank limit: ',num2str(delSing),'t: ',num2str(t)]);drawnow;
